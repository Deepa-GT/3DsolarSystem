...
// Move the camera down so the solar system appears higher (closer to top center)
camera.position.set(0, 60, 140); // y=60 instead of y=10 or y=40
camera.lookAt(0, 0, 0);
...
backBtn.addEventListener('click', () => {
  animateCameraTo({ x: 0, y: 60, z: 140 }, { x: 0, y: 0, z: 0 });
  backBtn.style.display = 'none';
  focusIdx = null;
});
